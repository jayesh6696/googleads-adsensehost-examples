...
/**
 * Retrieves a report for the specified publisher ad client.
 *
 * Tags: accounts.reports.generate
 */
class GenerateReportForPublisher {
  /**
   * Retrieves a report for the specified publisher ad client.
   *
   ...
   * @param $adClientId string the publisher ad client ID on which to run the
   *     report.
   */

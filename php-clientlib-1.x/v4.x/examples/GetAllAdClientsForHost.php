 ...
 * Tags: adclients.list
 */
class GetAllAdClientsForHost {
  /**
   * Gets all ad clients for the host.
   *
  ...
  public static function run($service, $maxPageSize) {
    ...
    print $separator;
    print "Listing all ad clients for host account\n";
    print $separator;
    ...
    do {
      ...
      if (!empty($result['items'])) {
        ...
        foreach ($adClients as $adClient) {
          ...
          printf("\tSupports reporting: ");
          if ($adClient['supportsReporting']) {
            print "Yes\n";
          } else {
            print "No\n";
          }
